...
$(document).ready(function(){
	...
	// var formStr = "( (ac {2r|a(\"sex\"),\"hallo\",b}) b) ((b)a)";
	// var formStr = "( (a {2r|open|x,y,z}) b)  ( {2r+1|a,b} (b)a )  {2r+1|open|a,b}";
	var formStr = "((a)b)c";
	console.log(formStr);
	...
	formJSON_obj = parseFormulaData(formStr);
	console.log(formJSON_obj);

	generateFromData(formJSON_obj);

});

function generateFromData(json) {
	/* Parses json data and generates the corresponding forms */
